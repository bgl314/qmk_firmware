...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    MT(KC_LALT,KC_ESC),LT(_NUMBERS, KC_TAB),MT(MOD_LCTL,KC_BSPC), LT(_NAV,KC_SPC),OSM(MOD_RSFT) , MO(_SYMBOLS)
    ),
    [_MOUSE] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    [_GAMES_QWE] = LAYOUT(
      //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
            ...
            KC_A,     KC_S,      KC_D,    KC_F,     KC_G,     KC_A,     KC_S,      KC_D,    KC_F,     KC_G,
   _______, KC_Z,    KC_X,       KC_C,    KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,   _______, 
                           MO(_GAMES_ALT),KC_TAB, KC_SPC,       _______, _______, KC_RGUI
         ),
    [_GAMES_ALT] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
                KC_ESC,   KC_F7,   KC_F8,  KC_F9,   KC_F10,       _______,  _______,  _______,  _______,  _______,
                KC_BSPC,  KC_F4,    KC_F5,   KC_F6,   KC_F11,       _______,  _______,  _______,  _______,  _______,
    _______,    KC_DEL,   KC_F1,    KC_F2,   KC_F3,   KC_F12,      _______,  _______,  _______,  _______,  _______,  _______,
                                    _______, _______, _______,   _______,  _______, _______
    ),
    [_SYMBOLS] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
                KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,     KC_CIRC,   KC_AMPR, KC_ASTR,   KC_LPRN, KC_RPRN,
                KC_TILDE, KC_GRV, KC_PIPE, KC_PLUS,  KC_EQL,    KC_LT,   KC_LPRN,  KC_LCBR,KC_LBRC, KC_GT,
