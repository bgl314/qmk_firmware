...
void render_layer_name(void) {
    ...
    bool games_qwe= layer_state_is(_GAMES_QWE);
    ...
    if(number){
        ...
        oled_write_P(PSTR("GMS_QWE"), led_state.caps_lock||capsword);
    } else {
...
/*
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,  KC_A,    ALT_R,     CTL_S,    SHT_T,    KC_D,                            KC_H,    SHT_N,    CTL_E,    ALT_I,    KC_O,_______,
    _______,KC_Z,    KC_X,   KC_C,    KC_V,    KC_B,       KC_MUTE,             KC_NO,   KC_K,    KC_M,    KC_COMM, KC_DOT, KC_SLSH,_______,
         MT(MOD_LGUI,KC_ESC),LT(_NUMBERS, KC_TAB),MT(MOD_LCTL,KC_BSPC), _______,_______,    LT(_NAV,KC_SPC),OSM(MOD_RSFT) , MO(_SYMBOLS)
    ),
    [_MOUSE] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷
            KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,                       KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,
    _______,SCROLL,KC_MS_BTN2,KC_MS_BTN3,KC_MS_BTN1,CPI_UP,                      KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,_______,
    _______,LCTL(KC_Z),LCTL(KC_X), LCTL(KC_C) ,LCTL(KC_V), CPI_DN ,  KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,_______,
                                    _______,KC_LALT,  KC_LSFT,  _______,    KC_NO,  KC_NO,  KC_NO,_______
    ),
    [_GAMES] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
...
//╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,KC_A,     KC_S,      KC_D,    KC_F,     KC_G,                         KC_A,     KC_S,      KC_D,    KC_F,     KC_G,_______,
    _______,  KC_Z,    KC_X,       KC_C,    KC_V,     KC_B,   _______,  _______,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH, _______,
                      MO(_GAMES_ALT),KC_TAB,    KC_SPC,  _______,   _______, _______, _______, KC_RGUI
    ),
    [_GAMES_ALT] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
            KC_F9, KC_F10,    KC_F11,   KC_F12, KC_NO,                       _______,  _______,  _______,  _______,  _______,
    _______,KC_F5, KC_F6,    KC_F7,   KC_F8,  KC_BSPC,                       KC_H,     KC_N,     KC_E,     KC_I,     KC_O,_______,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______, KC_TILDE, KC_GRV, KC_PIPE, KC_PLUS,    KC_EQL,                         KC_NO,  KC_LPRN,  KC_LCBR,KC_LBRC, KC_LT,_______,
    _______, KC_BSLS,  KC_NO, KC_UNDS, KC_MINUS,KC_NO ,   KC_MUTE,         KC_MPLY,  KC_NO,  KC_RPRN, KC_RCBR ,KC_RBRC, KC_GT,_______,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
     ...
     _______,  KC_PAST,    KC_4,    KC_5,  KC_6,    KC_PLUS,                            KC_PLUS,    KC_4,    KC_5,  KC_6,    KC_PAST,_______,
     _______, TD(DOT_ENT), KC_1,  KC_2,   KC_3,   KC_0,    KC_MPLY,        KC_MPLY,  KC_EQL,   KC_1,     KC_2,     KC_3,   TD(DOT_ENT),_______,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT,   KC_DEL,                       QK_CAPS_WORD_TOGGLE,  KC_RSFT, KC_RCTL,  KC_RALT,  KC_ESC,_______,
    _______, LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),LCTL(KC_V), KC_NO, KC_MUTE,   KC_MPLY,  KC_CAPS,   TD(TD_PAREN),  TD(TD_CBRC),    TD(TD_BKT),  KC_BSLS,_______,
    ...
    [_ADJUST] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
            RGB_TOG , KC_F7, KC_F8, KC_F9,   KC_F10,                                QK_HAPTIC_TOGGLE, AU_TOGG,   TO(_COLEMAK),    TG(_GAMES_QWE), TG(_GAMES),
    _______, RGB_MOD,KC_F4,KC_F5, KC_F6,       KC_F11,                              OSL(_PWDS),  OSM(MOD_RSFT), OSM(MOD_RCTL),  OSM(MOD_RALT),  OSM(MOD_RGUI),_______,
    _______, RGB_RMOD, KC_F1,   KC_F2,   KC_F3,   KC_F12,           KC_MUTE, KC_MPLY,    KC_MPRV,KC_VOLD, KC_VOLU, KC_MNXT,   MO(_ADJUST_ALT),_______,
                            _______, _______,   _______,    _______, _______,   _______, _______,  _______
    ),
    [_PWDS] = LAYOUT(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
             KC_NO, KC_NO,    KC_NO,   KC_NO, PWD_G ,               KC_NO, PWD_L,   KC_NO,    KC_NO, KC_NO ,
    _______, KC_NO, KC_NO,    PWD_S,   KC_NO,  PWD_D,               _______,  PWD_N, KC_NO,  KC_NO,  KC_NO,_______,
    _______,KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  _______,   _______,     KC_NO,KC_NO, KC_NO, KC_NO, _______,  _______,
                _______,        _______,   _______,     _______, _______,   _______,_______,   _______
    )
#else
 ,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
            RGB_TOG , KC_F7, KC_F8, KC_F9,   KC_F10,                                QK_HAPTIC_TOGGLE, AU_TOGG,   TO(_COLEMAK),    TG(_GAMES_QWE), TG(_GAMES),
    _______, RGB_MOD,KC_F4,KC_F5, KC_F6,       KC_F11,                                OSL(_PWDS),  OSM(MOD_RSFT), OSM(MOD_RCTL),  OSM(MOD_RALT),  OSM(MOD_RGUI),_______,
    _______, RGB_RMOD, KC_F1,   KC_F2,   KC_F3,   KC_F12,  KC_MUTE, KC_NO,           KC_MPRV, KC_VOLD,KC_VOLU, KC_MNXT,   MO(_ADJUST_ALT),_______,
                                _______,  _______,   _______,  _______,      _______,   _______,_______,  _______
    )
#endif
 ,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,_______, RGB_HUI,    RGB_SAI,   RGB_VAI,  QK_CLEAR_EEPROM,              _______,     _______,     _______,     _______,  _______,   _______,
